...
def test_select_face_track() -> None:
	...
	assert select_face_track([ face_track_overlap, face_track_distant ], face_overlap, 0.3, 1) is face_track_overlap
	assert select_face_track([ face_track_overlap, face_track_distant ], face_distant, 0.3, 1) == {}
	assert select_face_track([ face_track_overlap, face_track_distant ], face_overlap, 0.3, 0) == {}
